...
class Nine():
    def __init__(self):
        ...
        margin = 20
        self.positions = [
            self.bulb_off.get_rect(midleft=(margin, self.height // 2)),        
            self.bulb_off.get_rect(midright=(self.width - margin, self.height // 2)), 
            self.bulb_off.get_rect(midbottom=(self.width // 2, self.height - margin)) 
        ]
